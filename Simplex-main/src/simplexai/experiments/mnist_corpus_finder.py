...
def load_custom_corpus(
    ...
    # Automatic Corpus Selection Scheme
    corpus_pd = pd.DataFrame(dataset.numpy())
    ...
    return DataLoader(data_utils.TensorDataset(torch.Tensor(np.array(corpus_pd))), batch_size=batch_size, shuffle=shuffle)
